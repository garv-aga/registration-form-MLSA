  ...
  const {values,errors,touched,handleBlur,handleChange,handleSubmit } = useFormik({
    ...
    onSubmit: (values,action,event) => {
      ...
      axios.post(url,{
        ...
        kiitEmailId: values.kiitEmailId,
  ...
  return (
    ...
    <div className="registrationForm">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {(errors.name && touched.name)||(errors.rollNumber && touched.rollNumber)||(errors.currentYear && touched.currentYear)||(errors.branch && touched.branch)||(errors.kiitEmailId && touched.kiitEmailId)||(errors.personalEmailId && touched.personalEmailId)||(errors.phoneNumber && touched.phoneNumber)||(errors.linkedin && touched.linkedin)||(errors.github && touched.github) ? (
